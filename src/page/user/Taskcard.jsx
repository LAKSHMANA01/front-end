...
// Add the code you've shared here:
...
const getStatusStyle = (status) => {
  switch(status.toLowerCase()) {
    case 'completed': return 'text-green-600 bg-green-100 px-2 py-1 rounded-full';
    case 'in progress': return 'text-blue-600 bg-blue-100 px-2 py-1 rounded-full';
    case 'pending': return 'text-yellow-600 bg-yellow-100 px-2 py-1 rounded-full';
