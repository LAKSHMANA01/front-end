...
//           </div>
//           <div className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-600 to-purple-400"></div>
//         </div>
//       </div>
//     </nav>
//   );
...
const AdminNavbar = ({ onToggleTheme, isDarkMode = false, userName = "Admin", onSearch, onFilterChange }) => {
  ...
  return (
    <nav className="h-24 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4 w-full md:w-auto">
        ...
        <div className={`relative flex items-center w-full md:w-96 ${isSearchOpen ? "block" : "hidden md:block"}`}>
